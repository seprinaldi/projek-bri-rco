				...
				<div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
					...
					<div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
						...
						<div class="d-flex flex-row-fluid flex-column text-center p-5 p-lg-10 pt-lg-20">
							...
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="d-none d-lg-block fw-bold text-white fs-2qx pb-5 pb-md-10">PortalRCO</h1>
							<!--end::Title-->
							<!--begin::Description-->
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							@csrf
								...
								<div class="text-center mb-10">
									<!--begin::Title-->
									<h1 class="text-dark mb-3">Sign In to <span class="">PortalRCO</span> </h1>
									<!--end::Title-->
								</div>
								<!--begin::Heading-->
								<!--begin::Input group-->
								<div class="fv-row mb-10">
									<!--begin::Label-->
									<label class="form-label fs-6 fw-bold text-dark">PN</label>
									<!--end::Label-->
									<!--begin::Input-->
									<input class="form-control form-control-lg form-control-solid @error('pn') is-invalid @enderror" type="integer" name="pn" autofocus required value="{{ old('pn') }}" placeholder="Ex: 90176614"/>
									<!--end::Input-->
									@error('pn')
